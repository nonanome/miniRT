...
Intersections/identify_hits.o Intersections/cylinder_intersect.o Intersections/save_intersections.o Transformation/transformation.o default_values.o color_transform.o reflection.o initialisation.o world_building/base_world.o world_building/world_testing.o\
