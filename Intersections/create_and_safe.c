...
{
	return (discriminant_values[1] * discriminant_values[1] - 4 * discriminant_values[0] * discriminant_values[2]);
}
...
t_intersec *intersect_sphere(t_intersec *result, t_ray ray, t_shape sphere)
{
	...
	discriminant_values[2] = dot_product(sphere_to_ray, sphere_to_ray) - sphere.radius * sphere.radius;
